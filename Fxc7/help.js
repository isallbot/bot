...
│
│➻ *${prefix}tahta [ISALL]*
│➻ *${prefix}croman [ISALL dan BOT]*
│➻ *${prefix}cthunder [ISALL]*
│➻ *${prefix}cbpink [ISALL]*
│➻ *${prefix}cmwolf [ISALL]*
│➻ *${prefix}csky [ISALL]*
│➻ *${prefix}cwooden [ISALL]*
│➻ *${prefix}cflower [ISALL]*
│➻ *${prefix}clove [ISALL]*
│➻ *${prefix}ccrossfire [ISALL]*
│➻ *${prefix}cnaruto [ISALL]*
│➻ *${prefix}cparty [ISALL]*
│➻ *${prefix}cshadow [ISALL]*
│➻ *${prefix}cminion [ISALL]*
│➻ *${prefix}cneon [ISALL]*
│➻ *${prefix}cneon2 [ISALL]*
│➻ *${prefix}cneongreen [ISALL]*
│➻ *${prefix}c3d [ISALL]*
│➻ *${prefix}csky [ISALL]*
│➻ *${prefix}tts [id Haii]*
│➻ *${prefix}ttp [ISALL]*
│➻ *${prefix}cballon [ISALL]*
│➻ *${prefix}cpaper [ISALL]*
│➻ *${prefix}slide [ISALL BOT WA]*
│
│➻ *${prefix}stiker*
│➻ *${prefix}gifstiker*
│➻ *${prefix}toimg*
...
│➻ *${prefix}spamgmail [botISALL@gmail.com]*
┬
╰────────────────────────
